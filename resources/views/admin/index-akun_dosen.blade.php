...
@php
  $akundosen = [
    ['no' => '1', 'nidn' => '402842017', 'dosen' => 'Dr. Andi Saputra, M.Kom', 'email' => 'dosen@unwir.ac.id', 'aksi' => 'Aktif'],
    ['no' => '2', 'nidn' => '402842017', 'dosen' => 'Rina Wulandari, M.T', 'email' => 'dosen@unwir.ac.id', 'aksi' => 'Aktif'],
    ['no' => '3', 'nidn' => '402842017', 'dosen' => 'Prof. Bambang Hartono', 'email' => 'dosen@unwir.ac.id', 'aksi' => 'Aktif'],
    ...
    <table class="w-full text-sm">
      ...
      <tbody>
        ...
        <tr class="border-b border-line last:border-0 hover:bg-paper/60 transition-colors">
          ...
          <td class="py-3 pr-4 text-ink/70">{{ $mk['email'] }}</td>
          <td class="py-3 pr-4">
 ...
 <!-- Modal Tambah Pengguna -->
  ...
  >
    ...
    <div class="relative bg-white w-full max-w-md rounded-xl shadow-lg p-6">
      ...
      <form onsubmit="event.preventDefault(); alert('Data user (dummy): ' + document.getElementById('inputNama').value); document.getElementById('modalUser').classList.add('hidden');">
           <div class="mb-4">
