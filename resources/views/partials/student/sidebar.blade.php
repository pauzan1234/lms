...
<nav class="flex-1 overflow-y-auto px-4 py-5 space-y-6">
  ...
  <div class="space-y-1">
    ...
    <a href="{{ route('student.matakuliah.cari') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-paper/70 hover:bg-white/5 hover:text-paper text-sm font-medium transition-colors">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
